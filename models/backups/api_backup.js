...
async function fetchGeoData(boundingBox) {
            ...
            for (let data of record) { // Each record contains an array of data.
                ...
                if (building) {
                    ...
                    if (data.country && !coordinatesFound) { // data.country contains coordinates.
                        ...
                        let coords = extractGmlFromCountry(gmlString); // Perform some string magic and return the coords.
                        // console.log(coords);
                ...
                // ................................................................................
                    ...
                    if (data.contextSuperType && !coordinatesFound) {
                        let coords = extractCoordsFromContextSuperType(data.coordinates);
                        pinData.coords = coords;
...
function extractCoordsFromContextSuperType(gmlString) {
...
export { fetchGeoData, createPins }